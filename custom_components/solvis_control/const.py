...
REGISTERS = [
    ...
    ModbusFieldConfig(  # HKR1 Kurve Solltemperatur Tag3
        name="hkr1_kurve_solltemperatur_tag3",
        address=2824,
        unit="°C",
        device_class="temperature",
        state_class="measurement",
    ...
    ModbusFieldConfig(  # HKR1 Kurve Absenktemperatur
        name="hkr1_kurve_absenktemperatur",
        address=2825,
        unit="°C",
        device_class="temperature",
        state_class="measurement",
    ...
    ModbusFieldConfig(  # HKR1 Kurve Steilheit
        name="hkr1_kurve_steilheit",
        address=2826,
        unit="%",
        device_class="",
        state_class="",
