...
from .const import CONF_HOST, CONF_NAME, DATA_COORDINATOR, DOMAIN, REGISTERS, DEVICE_VERSION, CONF_OPTION_1, CONF_OPTION_2, CONF_OPTION_3, CONF_OPTION_4, CONF_OPTION_5
